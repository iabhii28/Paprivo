...
fun TextToPdfScreen(
    ...
    var pdfName by remember { mutableStateOf("TextDocument_${System.currentTimeMillis() / 1000}") }
                    ...
                    PrimaryActionButton(
                        ...
                        onClick = {
                            ...
                            coroutineScope.launch {
                                val result = viewModel.pdfOperations.createTextToPdf(
                                    text = textContent,
                                    fontSize = fontSize,
        ...
        LazyColumn(
            ...
            item {
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("Type or paste document content here...", color = colors.secondary) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(260.dp)
            ...
            item {
                ...
                SectionHeader(title = "FONT SIZE: ${fontSize.toInt()} pt")
                Slider(
                    value = fontSize,
